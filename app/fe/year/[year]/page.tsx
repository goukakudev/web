...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return makeMetadata({
    title: `${yearKey} 基本情報技術者試験 過去問 ${total} 問`,
    description: `基本情報技術者試験 ${yearKey} の過去問 ${yearExams.length} 回・全 ${total} 問の一覧。試験回ごとの出題内訳と解説リンク。`,
  ...
  return (
    <MobileFrame>
      <Breadcrumbs items={[
        ...
        { name: `${yearKey} 年度`, href: `/fe/year/${yearSlug}` },
      ]} />
      <JsonLd
        data={collectionPageJsonLd({
          name: `${yearKey} 基本情報技術者試験 過去問`,
          description: `基本情報技術者試験 ${yearKey} の試験回 ${yearExams.length} 件`,
